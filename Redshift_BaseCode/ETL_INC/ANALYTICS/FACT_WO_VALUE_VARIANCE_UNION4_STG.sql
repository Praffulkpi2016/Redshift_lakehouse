...
(
	...
	from
		bec_dwh.FACT_WO_VALUE_VARIANCE_UNION4_STG dw,
...
SELECT  e.organization_id,
				  ...
				  and (e.kca_seq_date > (select (executebegints-prune_days) from bec_etl_ctrl.batch_dw_info 
												where dw_table_name = 'fact_wo_value_variance_union4_stg'
												and batch_name = 'wip')
...
-----------------------------------------------------------------------------
-----------------------------------------------------------------------------
insert into bec_dwh.FACT_WO_VALUE_VARIANCE_UNION4_STG
(organization_id,
organization_id_key,
primary_item_id,
inventory_item_id,
