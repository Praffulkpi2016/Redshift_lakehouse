...
TRUNCATE bec_dwh.fact_cst_inv_distribution_stg1_tmp;
--Insert records into temp table
INSERT INTO bec_dwh.fact_cst_inv_distribution_stg1_tmp 
(
...
where dw_table_name ='fact_cst_inv_distribution_stg1' and batch_name = 'inv')
);
--delete records from fact table
delete from bec_dwh.fact_cst_inv_distribution_stg1
WHERE exists (select 1 from bec_dwh.fact_cst_inv_distribution_stg1_tmp tmp
              where tmp.transaction_id = fact_cst_inv_distribution_stg1.transaction_id
...
insert into bec_dwh.fact_cst_inv_distribution_stg1 
(
SELECT distinct
...
FROM
	...
	bec_dwh.fact_cst_inv_distribution_stg1_tmp tmp
WHERE
