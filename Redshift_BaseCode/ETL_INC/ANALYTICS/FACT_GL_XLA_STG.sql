...
-- Temp1
truncate table bec_dwh.cte_xla_ae_headers;
insert into bec_dwh.CTE_xla_ae_headers 
(
	Select 
    ...
    AND gl_transfer_status_code = 'Y'
		...
		and kca_seq_date >= (select (executebegints-prune_days) from bec_etl_ctrl.batch_dw_info where dw_table_name ='fact_gl_xla_stg' 
	and batch_name = 'gl'))
	) aeh
);
commit;
--Temp2
truncate table  bec_dwh.cte_xla_ae_lines;
insert into bec_dwh.cte_xla_ae_lines 
 (
...
commit;
truncate table bec_dwh.cte_xla_event_types_tl;
insert into bec_dwh.cte_xla_event_types_tl 
 (
...
truncate table bec_dwh.CTE_xla_Event_classes_tl;
insert into bec_dwh.CTE_xla_Event_classes_tl
(
...
truncate table bec_dwh.cte_xla_events ;
insert into bec_dwh.cte_xla_events 
(
	Select 
...
truncate table bec_dwh.CTE_xla_transaction_entities ;
insert into bec_dwh.CTE_xla_transaction_entities 
(
...
truncate table bec_dwh.CTE_xla_distribution_links ;
insert into bec_dwh.CTE_xla_distribution_links 
 (
...
truncate table bec_dwh.CTE_fnd_lookup_values ;
insert into bec_dwh.CTE_fnd_lookup_values 
 (
...
truncate table bec_dwh.CTE_fun_seq_versions1 ;
insert into bec_dwh.CTE_fun_seq_versions1 
 (
...
truncate table bec_dwh.CTE_OM;
insert into bec_dwh.CTE_OM 
 (
	SELECT
...
truncate table bec_dwh.CTE_REC;
insert into bec_dwh.CTE_REC 
 (
	SELECT
		hl.address1,
...
truncate table bec_dwh.CTE_ADJ;
insert into bec_dwh.CTE_ADJ 
 (
	SELECT
		hl.address1,
		adj.adjustment_id
...
truncate table bec_dwh.FACT_GL_XLA_STG;

insert into bec_dwh.FACT_GL_XLA_STG
