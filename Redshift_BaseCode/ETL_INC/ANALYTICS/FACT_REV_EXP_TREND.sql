...
delete from bec_dwh.FACT_REV_EXP_TREND
where exists 
(
select 1 from 
...
and (gb.kca_seq_date >= (select (executebegints-prune_days) from bec_etl_ctrl.batch_dw_info
     where dw_table_name = 'fact_rev_exp_trend' and batch_name = 'gl'))
...
INSERT INTO bec_dwh.fact_rev_exp_trend
(
select 
