...
DROP TABLE IF EXISTS bec_dwh.DIM_SEGMENT4_HCY;
CREATE TABLE bec_dwh.DIM_SEGMENT4_HCY diststyle all sortkey(structure,l1_vsid,l1_value,l2_value,l3_value,
...
WHERE
	DW_TABLE_NAME = 'dim_segment4_hcy'
	AND BATCH_NAME = 'gl';
