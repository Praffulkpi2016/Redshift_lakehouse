...
drop table if exists bec_dwh.DIM_SEGMENT2;

create table bec_dwh.DIM_SEGMENT2 diststyle all sortkey(chart_of_accounts_id,
ledger_id)
as
(
select distinct 
	...
	concat(f1.flex_value, concat('-',f1.description)) as seg2_value_desc,
...
on 
	...
	and s1.application_column_name = 'SEGMENT2'
);
end;
