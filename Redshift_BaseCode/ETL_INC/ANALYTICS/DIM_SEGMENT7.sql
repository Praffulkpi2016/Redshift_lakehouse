...
drop table if exists bec_dwh.DIM_SEGMENT7;

create table bec_dwh.DIM_SEGMENT7 diststyle all sortkey(ledger_id,chart_of_accounts_id,flex_value_set_id)
as
...
select distinct 
	...
	concat(f1.flex_value, concat('-',f1.description)) as seg7_value_desc,
...
on 
	...
	and s1.application_column_name = 'SEGMENT7');  
