...
# version: 2022.06
# description: This script represents full incremental approach for TEMPORARY STAGING TABLE.
# File Version: KPI v1.0
*/
begin;

Truncate table bec_dwh.FACT_CST_ONHAND_QTY_UNION1_STG;

Insert into bec_dwh.FACT_CST_ONHAND_QTY_UNION1_STG (
  select 
    segment1, 
    cat_seg1, 
    cat_seg2, 
