...
drop table if exists bec_dwh.DIM_SEGMENT8;

create table bec_dwh.DIM_SEGMENT8 diststyle all sortkey(ledger_id,chart_of_accounts_id,flex_value_set_id )
as
...
select distinct 
	...
	concat(f1.flex_value, concat('-',f1.description)) as seg8_value_desc,
