...
truncate table bec_dwh.FACT_BOM_COST_DETAILS;

insert into bec_dwh.FACT_BOM_COST_DETAILS 
select 
top_item_id
,assembly_item_id
,component_item_id
...
from
    bec_ods.xxbec_ibom_rc_temp xib,
    bec_ods.mtl_system_items_b msi,
    bec_ods.mtl_system_items_b msi2,
    bec_ods.bom_structures_b  bom,
    bec_ods.mtl_system_items_b msi3,
