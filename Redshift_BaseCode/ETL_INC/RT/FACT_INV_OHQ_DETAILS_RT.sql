...
# version: 2022.06
# description: This script represents incremental load approach for RT.
# File Version: KPI v1.0
*/
begin;

truncate table bec_dwh_rpt.FACT_INV_OHQ_DETAILS_RT;

insert into bec_dwh_rpt.FACT_INV_OHQ_DETAILS_RT
SELECT 
