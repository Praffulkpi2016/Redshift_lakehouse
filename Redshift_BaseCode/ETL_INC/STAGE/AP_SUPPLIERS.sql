...
*/
BEGIN;
TRUNCATE TABLE bec_ods_stg.AP_SUPPLIERS;


insert into bec_ods_stg.AP_SUPPLIERS
(
...
,kca_seq_date
 ...
 where kca_operation != 'DELETE' and nvl(kca_seq_id,'')!= '' 
	...
	(select vendor_id,max(KCA_SEQ_ID) from bec_raw_dl_ext.AP_SUPPLIERS 
     where kca_operation != 'DELETE' and nvl(kca_seq_id,'')!= ''
     group by vendor_id)
     and kca_seq_date > (select (executebegints-prune_days) from bec_etl_ctrl.batch_ods_info where ods_table_name ='ap_suppliers')
	 );
END;