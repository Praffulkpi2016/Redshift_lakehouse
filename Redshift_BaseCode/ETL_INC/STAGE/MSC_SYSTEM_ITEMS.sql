...
truncate table bec_ods_stg.msc_system_items;

insert into	bec_ods_stg.msc_system_items
   (	PLAN_ID,
		ORGANIZATION_ID,
		INVENTORY_ITEM_ID,
		SR_INSTANCE_ID,
...
(
	...
	(select SR_INSTANCE_ID,PLAN_ID,INVENTORY_ITEM_ID,ORGANIZATION_ID,max(kca_seq_id) from bec_raw_dl_ext.msc_system_items 
     where kca_operation != 'DELETE'  and nvl(kca_seq_id,'')!= ''
