...
truncate table bec_ods_stg.HZ_CUST_ACCOUNTS;

insert into	bec_ods_stg.HZ_CUST_ACCOUNTS
   (cust_account_id,
	party_id,
	last_update_date,
	account_number,
...
(
	...
	(select CUST_ACCOUNT_ID,max(kca_seq_id) from bec_raw_dl_ext.HZ_CUST_ACCOUNTS 
     where kca_operation != 'DELETE'  and nvl(kca_seq_id,'')!= ''
