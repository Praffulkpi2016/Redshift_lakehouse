...
truncate table bec_ods_stg.HZ_CUST_SITE_USES_ALL;
...
(	site_use_id,
	...
	kca_seq_date
    FROM
        bec_raw_dl_ext.hz_cust_site_uses_all
	where kca_operation != 'DELETE'  and nvl(kca_seq_id,'')!= '' 
	and (SITE_USE_ID,kca_seq_id) in 
	(select SITE_USE_ID,max(kca_seq_id) from bec_raw_dl_ext.hz_cust_site_uses_all 
     where kca_operation != 'DELETE'  and nvl(kca_seq_id,'')!= ''
