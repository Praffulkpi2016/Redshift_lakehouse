...
truncate table bec_ods_stg.OKC_K_HEADERS_ALL_B;

insert into	bec_ods_stg.OKC_K_HEADERS_ALL_B
   (id,
	contract_number,
	authoring_org_id,
...
(
	...
	(select ID,max(kca_seq_id) from bec_raw_dl_ext.OKC_K_HEADERS_ALL_B 
     where kca_operation != 'DELETE'  and nvl(kca_seq_id,'') != ''
     group by ID)
        and	(KCA_SEQ_DATE > (
		select
