...
begin;
truncate table bec_ods_stg.OE_ORDER_HEADERS_ALL;
insert into	bec_ods_stg.OE_ORDER_HEADERS_ALL
   (header_id,
	org_id,
	order_type_id,
	order_number,
...
(
	...
	(select HEADER_ID,max(kca_seq_id) from bec_raw_dl_ext.OE_ORDER_HEADERS_ALL 
     where kca_operation != 'DELETE'    and nvl(kca_seq_id,'') != ''
     group by HEADER_ID)
        and	(kca_seq_date > (
		select
