...
truncate
	table bec_ods_stg.MTL_SYSTEM_ITEMS_B;

insert
	into
	bec_ods_stg.mtl_system_items_b
(INVENTORY_ITEM_ID,
ORGANIZATION_ID,
LAST_UPDATE_DATE,
LAST_UPDATED_BY,
...
,kca_seq_id,
	kca_seq_date
	from
		bec_raw_dl_ext.mtl_system_items_b

where kca_operation != 'DELETE'  and nvl(kca_seq_id,'')!= '' and (INVENTORY_ITEM_ID,ORGANIZATION_ID,kca_seq_id) in (select INVENTORY_ITEM_ID,ORGANIZATION_ID,max(kca_seq_id) 
