...
truncate table bec_ods_stg.AP_CHECKS_ALL;

insert into	bec_ods_stg.ap_checks_all
(amount,
	bank_account_id,
	bank_account_name,
	check_date,
...
(
	select
		...
		kca_seq_date
	from
		bec_raw_dl_ext.AP_CHECKS_ALL
	where kca_operation != 'DELETE' and nvl(kca_seq_id,'')!= '' 
	and (check_id,kca_seq_id) in 
	(select check_id,max(kca_seq_id) from bec_raw_dl_ext.AP_CHECKS_ALL 
     where kca_operation != 'DELETE' and nvl(kca_seq_id,'')!= ''
     group by check_id)
     and kca_seq_date > (
		select
