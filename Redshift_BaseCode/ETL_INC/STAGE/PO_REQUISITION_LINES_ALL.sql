...
truncate table bec_ods_stg.PO_REQUISITION_LINES_ALL;

insert into	bec_ods_stg.PO_REQUISITION_LINES_ALL
   (requisition_line_id,
...
(
	...
	(select REQUISITION_LINE_ID,max(kca_seq_id) from bec_raw_dl_ext.PO_REQUISITION_LINES_ALL 
     where kca_operation != 'DELETE'  and nvl(kca_seq_id,'') != ''
