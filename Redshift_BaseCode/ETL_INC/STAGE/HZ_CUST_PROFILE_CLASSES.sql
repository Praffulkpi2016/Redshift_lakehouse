...
truncate table bec_ods_stg.HZ_CUST_PROFILE_CLASSES;
...
--	'N' as IS_DELETED_FLG,
	...
	kca_seq_date
    FROM
        bec_raw_dl_ext.hz_cust_profile_classes
	where kca_operation != 'DELETE'  and nvl(kca_seq_id,'')!= '' 
	and (PROFILE_CLASS_ID,kca_seq_id) in 
	(select PROFILE_CLASS_ID,max(kca_seq_id) from bec_raw_dl_ext.hz_cust_profile_classes 
     where kca_operation != 'DELETE'  and nvl(kca_seq_id,'')!= ''
