...
truncate table bec_ods_stg.RCV_TRANSACTIONS_INTERFACE;

insert into	bec_ods_stg.RCV_TRANSACTIONS_INTERFACE
   (
...
,        KCA_OPERATION,
	...
	(select INTERFACE_TRANSACTION_ID,max(kca_seq_id) from bec_raw_dl_ext.RCV_TRANSACTIONS_INTERFACE 
     where kca_operation != 'DELETE' and nvl(kca_seq_id,'')!= ''
