...
truncate table bec_ods_stg.MTL_SERIAL_NUMBERS_TEMP;

insert into	bec_ods_stg.MTL_SERIAL_NUMBERS_TEMP
   (
   TRANSACTION_TEMP_ID
,      LAST_UPDATE_DATE
,      LAST_UPDATED_BY
...
,        KCA_OPERATION,
	...
	(select TRANSACTION_TEMP_ID,FM_SERIAL_NUMBER,max(kca_seq_id) from bec_raw_dl_ext.MTL_SERIAL_NUMBERS_TEMP 
     where kca_operation != 'DELETE' and nvl(kca_seq_id,'')!= ''
