...
truncate table bec_ods_stg.pa_expenditure_items_all;

insert into	bec_ods_stg.pa_expenditure_items_all
   (	
	EXPENDITURE_ITEM_ID,
	LAST_UPDATE_DATE,
	LAST_UPDATED_BY,
...
(
	...
	(select nvl(EXPENDITURE_ITEM_ID,0) as EXPENDITURE_ITEM_ID,max(kca_seq_id) from bec_raw_dl_ext.pa_expenditure_items_all 
     where kca_operation != 'DELETE' and nvl(kca_seq_id,'')!= ''
