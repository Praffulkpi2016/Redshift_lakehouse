...
truncate table bec_ods_stg.csi_item_instances;

insert into	bec_ods_stg.csi_item_instances
   (	
	INSTANCE_ID,
	INSTANCE_NUMBER,
	EXTERNAL_REFERENCE,
...
(
	...
	(select nvl(INSTANCE_ID,0) as INSTANCE_ID,max(kca_seq_id) from bec_raw_dl_ext.csi_item_instances 
     where kca_operation != 'DELETE' and nvl(kca_seq_id,'')!= ''
