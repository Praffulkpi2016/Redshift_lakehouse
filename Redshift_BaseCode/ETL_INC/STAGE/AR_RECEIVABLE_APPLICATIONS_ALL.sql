...
truncate table bec_ods_stg.AR_RECEIVABLE_APPLICATIONS_ALL;

insert into	bec_ods_stg.AR_RECEIVABLE_APPLICATIONS_ALL
...
--	reversal_gl_date_context,
	...
	(select RECEIVABLE_APPLICATION_ID,max(kca_seq_id) from bec_raw_dl_ext.AR_RECEIVABLE_APPLICATIONS_ALL 
     where kca_operation != 'DELETE' and nvl(kca_seq_id,'')!= ''
