...
*/
BEGIN;
TRUNCATE TABLE bec_ods_stg.AP_INVOICES_ALL;


insert into bec_ods_stg.AP_INVOICES_ALL
(
...
,kca_seq_date
 ...
 where kca_operation != 'DELETE' and nvl(kca_seq_id,'')!= '' 
	...
	(select INVOICE_ID,max(KCA_SEQ_ID) from bec_raw_dl_ext.AP_INVOICES_ALL 
     where kca_operation != 'DELETE' and nvl(kca_seq_id,'')!= ''
     group by INVOICE_ID)
     and  kca_seq_date > (select (executebegints-prune_days) from bec_etl_ctrl.batch_ods_info where ods_table_name ='ap_invoices_all')
	 );
END;