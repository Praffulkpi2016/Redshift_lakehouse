...
truncate table bec_ods_stg.RA_CUSTOMER_TRX_ALL;

insert into	bec_ods_stg.RA_CUSTOMER_TRX_ALL
(
CUSTOMER_TRX_ID
,LAST_UPDATE_DATE
,LAST_UPDATED_BY
...
,KCA_SEQ_DATE
	...
	(select CUSTOMER_TRX_ID,max(kca_seq_id) from bec_raw_dl_ext.RA_CUSTOMER_TRX_ALL 
     where kca_operation != 'DELETE'  and nvl(kca_seq_id,'') != ''
