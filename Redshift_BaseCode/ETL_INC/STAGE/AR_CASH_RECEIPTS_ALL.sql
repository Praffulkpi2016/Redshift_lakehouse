...
truncate table bec_ods_stg.AR_CASH_RECEIPTS_ALL;

insert into	bec_ods_stg.AR_CASH_RECEIPTS_ALL
   (cash_receipt_id,
	last_updated_by,
	last_update_date,
	last_update_login,
...
(
	...
	(select CASH_RECEIPT_ID,max(kca_seq_id) from bec_raw_dl_ext.AR_CASH_RECEIPTS_ALL 
     where kca_operation != 'DELETE' and nvl(kca_seq_id,'')!= ''
