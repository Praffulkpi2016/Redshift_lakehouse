...
truncate
	table bec_ods_stg.ce_bank_accounts;
...
,kca_seq_date
	from
		bec_raw_dl_ext.ce_bank_accounts
where kca_operation != 'DELETE' and nvl(kca_seq_id,'')!= '' and (BANK_ACCOUNT_ID,kca_seq_id) in (select BANK_ACCOUNT_ID,max(kca_seq_id) from bec_raw_dl_ext.ce_bank_accounts 
where kca_operation != 'DELETE' and nvl(kca_seq_id,'')!= ''
group by BANK_ACCOUNT_ID) and
		kca_seq_date > (
		select
