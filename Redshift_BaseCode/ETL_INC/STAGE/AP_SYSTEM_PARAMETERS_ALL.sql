...
truncate
	table bec_ods_stg.ap_system_parameters_all;
...
(
	select
		...
		kca_seq_date
	from
		bec_raw_dl_ext.ap_system_parameters_all
		where kca_operation != 'DELETE' and nvl(kca_seq_id,'')!= '' 
	and (SET_OF_BOOKS_ID,ORG_ID,KCA_SEQ_ID) in 
	(select SET_OF_BOOKS_ID,ORG_ID,max(KCA_SEQ_ID) from bec_raw_dl_ext.ap_system_parameters_all 
     where kca_operation != 'DELETE' and nvl(kca_seq_id,'')!= ''
     group by SET_OF_BOOKS_ID,ORG_ID)
     and kca_seq_date > (
		select
