...
truncate table bec_ods_stg.RA_CUSTOMER_TRX_LINES_ALL;

insert into	bec_ods_stg.RA_CUSTOMER_TRX_LINES_ALL
...
,KCA_SEQ_DATE	
	...
	(select CUSTOMER_TRX_LINE_ID,max(kca_seq_id) from bec_raw_dl_ext.RA_CUSTOMER_TRX_LINES_ALL 
     where kca_operation != 'DELETE'  and nvl(kca_seq_id,'') != ''
