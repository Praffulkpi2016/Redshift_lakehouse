...
truncate table bec_ods_stg.BOM_COMPONENTS_B;

insert into	bec_ods_stg.BOM_COMPONENTS_B
   (operation_seq_num,
	component_item_id,
	last_update_date,
	last_updated_by,
...
(
	...
	(select COMPONENT_SEQUENCE_ID,max(kca_seq_id) from bec_raw_dl_ext.BOM_COMPONENTS_B 
     where kca_operation != 'DELETE' and nvl(kca_seq_id,'')!= ''
