...
truncate table bec_ods_stg.AR_PAYMENT_SCHEDULES_ALL;

insert into	bec_ods_stg.AR_PAYMENT_SCHEDULES_ALL
   (payment_schedule_id,
	last_update_date,
	last_updated_by,
	creation_date,
...
(
	...
	(select PAYMENT_SCHEDULE_ID,max(kca_seq_id) from bec_raw_dl_ext.AR_PAYMENT_SCHEDULES_ALL 
     where kca_operation != 'DELETE' and nvl(kca_seq_id,'')!= ''
