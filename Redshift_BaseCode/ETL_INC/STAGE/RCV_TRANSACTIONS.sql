...
truncate table bec_ods_stg.RCV_TRANSACTIONS;

insert into	bec_ods_stg.RCV_TRANSACTIONS
   (transaction_id,
	last_update_date,
	last_updated_by,
	creation_date,
...
(
	...
	(select TRANSACTION_ID,max(kca_seq_id) from bec_raw_dl_ext.RCV_TRANSACTIONS 
     where kca_operation != 'DELETE'  and nvl(kca_seq_id,'') != ''
