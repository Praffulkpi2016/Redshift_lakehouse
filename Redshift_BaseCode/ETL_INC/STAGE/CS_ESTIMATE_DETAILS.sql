...
truncate table bec_ods_stg.CS_ESTIMATE_DETAILS;

insert into	bec_ods_stg.CS_ESTIMATE_DETAILS
   (	
	estimate_detail_id,
	last_update_date,
	last_updated_by,
...
(
	...
	(select nvl(ESTIMATE_DETAIL_ID,0) as ESTIMATE_DETAIL_ID,max(kca_seq_id) from bec_raw_dl_ext.CS_ESTIMATE_DETAILS 
     where kca_operation != 'DELETE' and nvl(kca_seq_id,'')!= ''
