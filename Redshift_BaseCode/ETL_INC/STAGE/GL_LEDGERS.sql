...
,kca_seq_id,
	kca_seq_date
	from
		bec_raw_dl_ext.gl_ledgers
where kca_operation != 'DELETE'  and nvl(kca_seq_id,'')!= '' and (LEDGER_ID,kca_seq_id)
in  (select LEDGER_ID,max(kca_seq_id) from bec_raw_dl_ext.GL_LEDGERS 
where kca_operation != 'DELETE'  and nvl(kca_seq_id,'')!= ''
group by LEDGER_ID) AND
		( kca_seq_date > (
		select
