...
truncate table bec_ods_stg.HZ_CUST_PROFILE_AMTS;
...
insert
	...
	kca_seq_date
    FROM
        bec_raw_dl_ext.hz_cust_profile_amts
	where kca_operation != 'DELETE'  and nvl(kca_seq_id,'')!= '' 
	and (CUST_ACCT_PROFILE_AMT_ID,kca_seq_id) in 
	(select CUST_ACCT_PROFILE_AMT_ID,max(kca_seq_id) from bec_raw_dl_ext.hz_cust_profile_amts 
     where kca_operation != 'DELETE'  and nvl(kca_seq_id,'')!= ''
