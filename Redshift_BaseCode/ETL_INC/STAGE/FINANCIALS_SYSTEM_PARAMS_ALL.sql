...
truncate table bec_ods_stg.FINANCIALS_SYSTEM_PARAMS_ALL;

insert into	bec_ods_stg.FINANCIALS_SYSTEM_PARAMS_ALL
   (last_update_date,
	last_updated_by,
	set_of_books_id,
...
(
	...
	(select ORG_ID,SET_OF_BOOKS_ID,max(kca_seq_id) from bec_raw_dl_ext.FINANCIALS_SYSTEM_PARAMS_ALL 
     where kca_operation != 'DELETE' and nvl(kca_seq_id,'')!= ''
