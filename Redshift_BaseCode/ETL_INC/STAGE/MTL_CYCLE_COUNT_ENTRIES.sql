...
truncate table bec_ods_stg.MTL_CYCLE_COUNT_ENTRIES;

insert into	bec_ods_stg.mtl_cycle_count_entries
...
(
	...
	(select CYCLE_COUNT_ENTRY_ID,max(kca_seq_id) from bec_raw_dl_ext.MTL_CYCLE_COUNT_ENTRIES 
     where kca_operation != 'DELETE'  and nvl(kca_seq_id,'')!= ''
