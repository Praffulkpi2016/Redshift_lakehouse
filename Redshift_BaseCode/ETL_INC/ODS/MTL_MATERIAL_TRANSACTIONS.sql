...
where
	...
	from
		...
		bec_ods_stg.MTL_MATERIAL_TRANSACTIONS stg
	where
...
-- Soft delete
update bec_ods.MTL_MATERIAL_TRANSACTIONS set IS_DELETED_FLG = 'N';
commit;
update bec_ods.MTL_MATERIAL_TRANSACTIONS set IS_DELETED_FLG = 'Y'
where (TRANSACTION_ID )  in
(
select TRANSACTION_ID  from bec_raw_dl_ext.MTL_MATERIAL_TRANSACTIONS
