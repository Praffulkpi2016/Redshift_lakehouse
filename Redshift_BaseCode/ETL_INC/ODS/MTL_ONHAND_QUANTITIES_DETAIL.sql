...
where
	...
	from
		bec_ods.MTL_ONHAND_QUANTITIES_DETAIL ods,
		bec_ods_stg.MTL_ONHAND_QUANTITIES_DETAIL stg
	where
...
-- Soft delete
update bec_ods.MTL_ONHAND_QUANTITIES_DETAIL set IS_DELETED_FLG = 'N';
commit;
update bec_ods.MTL_ONHAND_QUANTITIES_DETAIL set IS_DELETED_FLG = 'Y',kca_seq_date = sysdate
