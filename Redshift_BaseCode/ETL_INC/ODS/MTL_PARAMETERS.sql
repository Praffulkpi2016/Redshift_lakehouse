...
delete from bec_ods.mtl_parameters
where ORGANIZATION_ID in (
select stg.ORGANIZATION_ID from bec_ods.mtl_parameters ods, bec_ods_stg.mtl_parameters stg
...
where kca_operation IN ('INSERT','UPDATE') and (ORGANIZATION_ID,kca_seq_id) in (select ORGANIZATION_ID,max(kca_seq_id) from bec_ods_stg.mtl_parameters 
...
-- Soft delete
update bec_ods.mtl_parameters set IS_DELETED_FLG = 'N';
commit;
update bec_ods.mtl_parameters set IS_DELETED_FLG = 'Y'
where (ORGANIZATION_ID )  in
(
select ORGANIZATION_ID  from bec_raw_dl_ext.mtl_parameters
