...
delete from bec_ods.PO_REQUISITION_LINES_ALL
where REQUISITION_LINE_ID in (
select stg.REQUISITION_LINE_ID
from bec_ods.PO_REQUISITION_LINES_ALL ods, bec_ods_stg.PO_REQUISITION_LINES_ALL stg
where ods.REQUISITION_LINE_ID = stg.REQUISITION_LINE_ID
...
(
	...
	uda_template_id,
       ...
       'N' AS IS_DELETED_FLG,
		...
		KCA_SEQ_DATE
	from bec_ods_stg.PO_REQUISITION_LINES_ALL
	where kca_operation in ('INSERT','UPDATE') 
	and (REQUISITION_LINE_ID,kca_seq_id) in 
	(select REQUISITION_LINE_ID,max(kca_seq_id) from bec_ods_stg.PO_REQUISITION_LINES_ALL 
     where kca_operation in ('INSERT','UPDATE')
...
-- Soft delete
update bec_ods.PO_REQUISITION_LINES_ALL set IS_DELETED_FLG = 'N';
commit;
update bec_ods.PO_REQUISITION_LINES_ALL set IS_DELETED_FLG = 'Y'
where (REQUISITION_LINE_ID)  in
(
select REQUISITION_LINE_ID from bec_raw_dl_ext.PO_REQUISITION_LINES_ALL
where (REQUISITION_LINE_ID,KCA_SEQ_ID)
in 
(
select REQUISITION_LINE_ID,max(KCA_SEQ_ID) as KCA_SEQ_ID 
...
where ods_table_name = 'po_requisition_lines_all';
