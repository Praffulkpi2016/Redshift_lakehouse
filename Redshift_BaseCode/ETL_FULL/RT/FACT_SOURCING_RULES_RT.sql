...
drop table if exists bec_dwh.FACT_SOURCING_RULES_RT_STG1;

create table bec_dwh.FACT_SOURCING_RULES_RT_STG1 as
...
drop table if exists bec_dwh.FACT_SOURCING_RULES_RT_STG2;

create table bec_dwh.FACT_SOURCING_RULES_RT_STG2 as
(WITH MRP_ASSIGNMENTS AS (
  SELECT 
    organization_id, 
    inventory_item_id, 
...
drop 
  table if exists bec_dwh_rpt.FACT_SOURCING_RULES_RT;
  
create table bec_dwh_rpt.FACT_SOURCING_RULES_RT 
diststyle auto 
