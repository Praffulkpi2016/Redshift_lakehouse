...
begin;
drop table if exists bec_ods.ap_terms_tl;

CREATE TABLE IF NOT EXISTS bec_ods.ap_terms_tl
(
	...
	,due_cutoff_day NUMERIC(15,0)   ENCODE az64
...
select
	...
	,kca_seq_date
from
	bec_ods_stg.ap_terms_tl);
end;

 
update bec_etl_ctrl.batch_ods_info set load_type = 'I', last_refresh_date = getdate() where ods_table_name='ap_terms_tl'; 
