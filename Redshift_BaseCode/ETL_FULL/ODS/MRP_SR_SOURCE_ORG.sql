...
DROP TABLE if exists bec_ods.MRP_SR_SOURCE_ORG;

CREATE TABLE IF NOT EXISTS bec_ods.MRP_SR_SOURCE_ORG
(
	sr_source_id NUMERIC(15,0)   ENCODE az64
	...
	,old_rank NUMERIC(15,0)   ENCODE az64
