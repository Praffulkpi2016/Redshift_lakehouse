...
DROP TABLE if exists bec_ods.MTL_TRANSACTION_ACCOUNTS;

CREATE TABLE IF NOT EXISTS bec_ods.MTL_TRANSACTION_ACCOUNTS
(
	...
	,INV_SUB_LEDGER_ID NUMERIC(15,0)   ENCODE az64 
	,KCA_OPERATION VARCHAR(10)   ENCODE lzo
    ,IS_DELETED_FLG VARCHAR(2) ENCODE lzo
	,kca_seq_id NUMERIC(36,0)   ENCODE az64
	,VALID_RECORDS_FLG VARCHAR(2) ENCODE lzo
...
INSERT INTO bec_ods.MTL_TRANSACTION_ACCOUNTS (
    ...
    SELECT
		...
		kca_seq_date
    FROM
        bec_ods_stg.MTL_TRANSACTION_ACCOUNTS;
