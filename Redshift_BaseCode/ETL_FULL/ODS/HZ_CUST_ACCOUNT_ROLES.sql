...
DROP TABLE if exists bec_ods.HZ_CUST_ACCOUNT_ROLES;

CREATE TABLE IF NOT EXISTS bec_ods.hz_cust_account_roles
(
	cust_account_role_id NUMERIC(15,0)   ENCODE az64
	,party_id NUMERIC(15,0)   ENCODE az64
	,cust_account_id NUMERIC(15,0)   ENCODE az64
	,current_role_state VARCHAR(30)   ENCODE lzo
	,current_role_state_effective TIMESTAMP WITHOUT TIME ZONE   ENCODE az64
	...
	,role_type VARCHAR(30)   ENCODE lzo
...
INSERT INTO bec_ods.HZ_CUST_ACCOUNT_ROLES (
	...
	kca_seq_date
    FROM
        bec_ods_stg.HZ_CUST_ACCOUNT_ROLES;
