...
DROP TABLE if exists bec_ods.PO_AGENTS;

CREATE TABLE IF NOT EXISTS bec_ods.PO_AGENTS
(
	agent_id NUMERIC(15,0)   ENCODE az64
	...
	,attribute_category VARCHAR(240)   ENCODE lzo
	...
	,IS_CONTRACT_OFFICER VARCHAR(1)   ENCODE lzo
	,WARRANT_ID NUMERIC(15,0)   ENCODE az64
