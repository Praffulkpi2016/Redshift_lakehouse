...
DROP TABLE if exists bec_ods.OE_ORDER_HOLDS_ALL;

CREATE TABLE IF NOT EXISTS bec_ods.OE_ORDER_HOLDS_ALL
(
	 ...
	 CREDIT_PROFILE_LEVEL VARCHAR(30) ENCODE lzo, 
...
INSERT INTO bec_ods.OE_ORDER_HOLDS_ALL (
    ...
    SELECT
		...
		,kca_seq_date
    FROM
        bec_ods_stg.OE_ORDER_HOLDS_ALL;
