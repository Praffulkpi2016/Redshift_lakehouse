...
DROP TABLE if exists bec_ods.fa_categories_tl;

CREATE TABLE IF NOT EXISTS bec_ods.fa_categories_tl
(
	CATEGORY_ID NUMERIC(15,0)   ENCODE az64
	,"LANGUAGE" VARCHAR(4)   ENCODE lzo
	,SOURCE_LANG VARCHAR(4)   ENCODE lzo
	,DESCRIPTION VARCHAR(40)   ENCODE lzo
