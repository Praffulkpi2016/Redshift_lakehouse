...
DROP TABLE if exists bec_ods.AR_RECEIPT_METHODS;

CREATE TABLE IF NOT EXISTS bec_ods.ar_receipt_methods
(
	...
	,auto_print_program_id NUMERIC(15,0)   ENCODE az64
	,auto_trans_program_id NUMERIC(15,0)   ENCODE az64
	,end_date TIMESTAMP WITHOUT TIME ZONE   ENCODE az64
	,last_update_login NUMERIC(15,0)   ENCODE az64
	,lead_days NUMERIC(5,0)   ENCODE az64
	,maturity_date_rule_code VARCHAR(30)   ENCODE lzo
	,receipt_creation_rule_code VARCHAR(30)   ENCODE lzo
	...
	,printed_name VARCHAR(30)   ENCODE lzo
	...
	,merchant_id NUMERIC(15,0)   ENCODE az64
	,receipt_inherit_inv_num_flag VARCHAR(1)   ENCODE lzo
	,dm_inherit_receipt_num_flag VARCHAR(1)   ENCODE lzo
	,br_cust_trx_type_id NUMERIC(15,0)   ENCODE az64
	,br_min_acctd_amount NUMERIC(28,10)   ENCODE az64
	,br_max_acctd_amount NUMERIC(28,10)   ENCODE az64
	,br_inherit_inv_num_flag VARCHAR(1)   ENCODE lzo
	,merchant_ref VARCHAR(80)   ENCODE lzo
	,payment_channel_code VARCHAR(30)   ENCODE lzo
...
INSERT INTO bec_ods.AR_RECEIPT_METHODS (
	...
	kca_seq_date
    FROM
        bec_ods_stg.AR_RECEIPT_METHODS;
