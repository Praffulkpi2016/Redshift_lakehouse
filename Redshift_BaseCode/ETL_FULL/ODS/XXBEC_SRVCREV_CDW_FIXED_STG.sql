...
DROP TABLE if exists bec_ods.XXBEC_SRVCREV_CDW_FIXED_STG;

CREATE TABLE IF NOT EXISTS bec_ods.XXBEC_SRVCREV_CDW_FIXED_STG
(
	...
	,acctd_amount_ledger_curr NUMERIC(28,10)   ENCODE az64
...
(
  "source",
	...
	query_name,
		...
		,kca_seq_date
    FROM
        bec_ods_stg.XXBEC_SRVCREV_CDW_FIXED_STG;
