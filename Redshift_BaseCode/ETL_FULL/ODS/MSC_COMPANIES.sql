...
DROP TABLE if exists bec_ods.MSC_COMPANIES;

CREATE TABLE IF NOT EXISTS bec_ods.MSC_COMPANIES
(
	 COMPANY_ID NUMERIC(15,0)   ENCODE az64
	,COMPANY_NAME VARCHAR(1000)   ENCODE lzo
