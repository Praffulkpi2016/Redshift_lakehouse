...
DROP TABLE if exists bec_ods.MTL_GENERIC_DISPOSITIONS;

CREATE TABLE IF NOT EXISTS bec_ods.MTL_GENERIC_DISPOSITIONS
(
	...
	,distribution_account NUMERIC(15,0)   ENCODE az64
...
INSERT INTO bec_ods.MTL_GENERIC_DISPOSITIONS (
	disposition_id,
	organization_id,
	last_update_date,
	last_updated_by,
