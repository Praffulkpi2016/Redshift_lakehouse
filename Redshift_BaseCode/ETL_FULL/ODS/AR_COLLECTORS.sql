...
DROP TABLE if exists bec_ods.AR_COLLECTORS;

CREATE TABLE IF NOT EXISTS bec_ods.AR_COLLECTORS
(
	...
	,alias VARCHAR(240)   ENCODE lzo
	,telephone_number VARCHAR(25)   ENCODE lzo
