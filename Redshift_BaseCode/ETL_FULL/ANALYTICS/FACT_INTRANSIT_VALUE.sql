...
drop table if exists bec_dwh.FACT_INTRANSIT_VALUE;

create table bec_dwh.FACT_INTRANSIT_VALUE 
	distkey(SUPPLY_SOURCE_ID)
	sortkey (SUPPLY_SOURCE_ID,SUPPLY_TYPE_CODE)
as
(
SELECT
    MS.ITEM_ID,
	...
	SER.SERIAL_NUM,
	LOT.LOT_NUM,
	DECODE (SER.SERIAL_NUM,	NULL,NVL (LOT.PRIMARY_QUANTITY,	MRP_PRIMARY_QUANTITY),1) SET_LOT_QTY,
	CIC.ITEM_COST,
	DECODE (SER.SERIAL_NUM, NULL,NVL (LOT.PRIMARY_QUANTITY,	MRP_PRIMARY_QUANTITY),1) * CIC.ITEM_COST EXTENDED_COST,
	MS.SUPPLY_TYPE_CODE,
	MS.SUPPLY_SOURCE_ID,
	MS.REQ_HEADER_ID,
	MS.REQ_LINE_ID,
