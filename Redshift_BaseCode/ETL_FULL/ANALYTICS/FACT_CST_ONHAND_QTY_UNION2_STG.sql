...
drop table if exists bec_dwh.FACT_CST_ONHAND_QTY_UNION2_STG;

create table bec_dwh.FACT_CST_ONHAND_QTY_UNION2_STG 
	diststyle all
	sortkey (segment1,inventory_item_id,organization_id)
as
(
select
	mmt.segment1,
...
where
	dw_table_name = 'fact_cst_onhand_qty_union2_stg'
