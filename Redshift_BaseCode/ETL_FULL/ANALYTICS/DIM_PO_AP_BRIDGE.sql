...
drop table if exists bec_dwh.DIM_PO_AP_BRIDGE;

create table bec_dwh.DIM_PO_AP_BRIDGE
DISTKEY (INVOICE_ID)
SORTKEY (INVOICE_ID, PO_LINE_LOCATION_ID, INVOICE_PAYMENT_ID, HOLD_ID, PAYMENT_NUM, PO_HEADER_ID, PO_LINE_ID, PO_RELEASE_ID, PO_LINE_LOCATION_ID, PO_DISTRIBUTION_ID, CHECK_ID, RCV_SHIPMENT_LINE_ID)
as 
(
	SELECT distinct 
	INV.ORG_ID,
