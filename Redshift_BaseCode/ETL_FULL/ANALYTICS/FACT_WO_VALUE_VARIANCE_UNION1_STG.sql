...
# version: 2022.06
# description: This script represents full load approach for Stage Table.
# File Version: KPI v1.0
*/
begin;

drop table if exists bec_dwh.FACT_WO_VALUE_VARIANCE_UNION1_STG;

create table bec_dwh.FACT_WO_VALUE_VARIANCE_UNION1_STG diststyle all 
...
wro as (
	...
	where
		operation_seq_num >= 0
--		and last_update_date > (select (executebegints-prune_days) from bec_etl_ctrl.batch_dw_info 
