...
drop table if exists bec_dwh.DIM_SEGMENT10_HCY;

create table bec_dwh.DIM_SEGMENT10_HCY diststyle all sortkey(l1_vsid,l1_value,l2_value,l3_value,l4_value,l5_value,l6_value ,l7_value,l8_value,l9_value,l10_value)
as
(
select  distinct
...
from (select fifs.flex_value_set_id vsid,
      ...
      from bec_ods.fnd_id_flex_segments fifs 
  ...
  join (select h1.flex_value_set_id l1_vsid,
        ...
        from bec_ods.gl_seg_val_norm_hierarchy h1
...
where
	dw_table_name = 'dim_segment10_hcy'
	and batch_name = 'gl';
