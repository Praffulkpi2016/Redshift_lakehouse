...
drop table if exists bec_dwh.DIM_SEGMENT5_HCY;

create table bec_dwh.DIM_SEGMENT5_HCY diststyle all sortkey(structure,l1_value,l2_value,l3_value,l4_value,l5_value,l6_value,l7_value,l8_value,l9_value,l10_value)
as
...
where
	dw_table_name = 'dim_segment5_hcy'
	and batch_name = 'gl';
