...
*/ 
begin;
drop table if exists bec_dwh.FACT_PEND_INV_COST_ADJ;

create table bec_dwh.FACT_PEND_INV_COST_ADJ diststyle all sortkey (organization_code,subinventory_code)
as 
(select  
inventory_item_id
,organization_id
