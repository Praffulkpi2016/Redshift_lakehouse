...
drop table if exists bec_dwh.FACT_PO_REQUISITIONS;

create table bec_dwh.FACT_PO_REQUISITIONS diststyle all sortkey(PO_HEADER_ID,PO_LINE_ID,REQ_DISTRIBUTION_ID)
as  (
SELECT distinct
    RQ.ORG_ID,
