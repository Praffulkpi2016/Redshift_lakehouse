...
drop table if exists bec_dwh.FACT_INV_ONHAND_TMP1;

create table bec_dwh.FACT_INV_ONHAND_TMP1 diststyle all sortkey(TRANSACTION_ID,inventory_item_id,organization_id)
as
SELECT   
