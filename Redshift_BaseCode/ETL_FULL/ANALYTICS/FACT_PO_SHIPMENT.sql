...
DROP TABLE IF EXISTS BEC_DWH.FACT_PO_SHIPMENT;

CREATE TABLE BEC_DWH.FACT_PO_SHIPMENT DISTSTYLE ALL SORTKEY (PO_HEADER_ID,PO_LINE_ID,LOT_NUM,
...
WHERE
	DW_TABLE_NAME = 'fact_po_shipment'
	AND BATCH_NAME = 'po';