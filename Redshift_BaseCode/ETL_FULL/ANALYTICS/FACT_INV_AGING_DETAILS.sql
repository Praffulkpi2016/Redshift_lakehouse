...
drop table if exists bec_dwh.FACT_INV_AGING_DETAILS;

create table bec_dwh.FACT_INV_AGING_DETAILS distkey(serial_number)
sortkey(inventory_item_id,organization_id) as 
SELECT 
organization_id, 
  description, 
  part_number, 
