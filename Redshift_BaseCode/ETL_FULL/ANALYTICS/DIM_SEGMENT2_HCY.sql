...
begin;
drop table if exists bec_dwh.DIM_SEGMENT2_HCY;
create table  bec_dwh.dim_segment2_hcy diststyle all sortkey(structure,l1_vsid,l1_value,l2_value,l3_value,
...
where
	dw_table_name = 'dim_segment2_hcy'
	and batch_name = 'gl';
