DROP TABLE IF EXISTS silver_bec_ods.OE_ORDER_LINES_ALL;
CREATE TABLE IF NOT EXISTS silver_bec_ods.OE_ORDER_LINES_ALL (
  ...
  pricing_quantity DECIMAL(28, 10),
  pricing_quantity_uom STRING,
  cancelled_quantity DECIMAL(28, 10),
  shipped_quantity DECIMAL(28, 10),
  ordered_quantity DECIMAL(28, 10),
  fulfilled_quantity DECIMAL(28, 10),
  shipping_quantity DECIMAL(28, 10),
  shipping_quantity_uom STRING,
  delivery_lead_time DECIMAL(15, 0),
  ...
  intmed_ship_to_org_id DECIMAL(15, 0),
  intmed_ship_to_contact_id DECIMAL(15, 0),
  sold_from_org_id DECIMAL(15, 0),
  sold_to_org_id DECIMAL(15, 0),
  cust_po_number STRING,
  ship_tolerance_above DECIMAL(15, 0),
  ship_tolerance_below DECIMAL(15, 0),
  demand_bucket_type_code STRING,
  veh_cus_item_cum_key_id DECIMAL(15, 0),
  rla_schedule_type_code STRING,
  ...
  source_document_line_id DECIMAL(15, 0),
  reference_line_id DECIMAL(15, 0),
  reference_type STRING,
  reference_header_id DECIMAL(15, 0),
  item_revision STRING,
  unit_selling_price DECIMAL(28, 10),
  unit_list_price DECIMAL(28, 10),
  tax_value DECIMAL(28, 10),
  context STRING,
  attribute1 STRING,
  attribute2 STRING,
  attribute3 STRING,
  ...
  industry_attribute1 STRING,
  industry_attribute2 STRING,
  industry_attribute3 STRING,
  industry_attribute4 STRING,
  industry_attribute5 STRING,
  industry_attribute6 STRING,
  industry_attribute7 STRING,
  industry_attribute8 STRING,
  industry_attribute9 STRING,
  industry_attribute10 STRING,
  industry_attribute11 STRING,
  industry_attribute13 STRING,
  industry_attribute12 STRING,
  industry_attribute14 STRING,
  industry_attribute15 STRING,
  industry_attribute16 STRING,
  industry_attribute17 STRING,
  industry_attribute18 STRING,
  industry_attribute19 STRING,
  industry_attribute20 STRING,
  industry_attribute21 STRING,
  industry_attribute22 STRING,
  industry_attribute23 STRING,
  industry_attribute24 STRING,
  industry_attribute25 STRING,
  industry_attribute26 STRING,
  industry_attribute27 STRING,
  industry_attribute28 STRING,
  industry_attribute29 STRING,
  industry_attribute30 STRING,
  ...
  link_to_line_id DECIMAL(15, 0),
  component_sequence_id DECIMAL(15, 0),
  component_code STRING,
  config_display_sequence DECIMAL(15, 0),
  sort_order STRING,
  item_type_code STRING,
  option_number DECIMAL(15, 0),
  option_flag STRING,
  dep_plan_required_flag STRING,
  visible_demand_flag STRING,
  line_category_code STRING,
  actual_shipment_date TIMESTAMP,
  customer_trx_line_id DECIMAL(15, 0),
  return_context STRING,
  return_attribute1 STRING,
  return_attribute2 STRING,
  return_attribute3 STRING,
  return_attribute4 STRING,
  return_attribute5 STRING,
  return_attribute6 STRING,
  return_attribute7 STRING,
  return_attribute8 STRING,
  return_attribute9 STRING,
  return_attribute10 STRING,
  return_attribute11 STRING,
  return_attribute12 STRING,
  return_attribute13 STRING,
  return_attribute14 STRING,
  return_attribute15 STRING,
  actual_arrival_date TIMESTAMP,
  ato_line_id DECIMAL(15, 0),
  auto_selected_quantity DECIMAL(28, 10),
  component_number DECIMAL(15, 0),
  earliest_acceptable_date TIMESTAMP,
  explosion_date TIMESTAMP,
  latest_acceptable_date TIMESTAMP,
  model_group_number DECIMAL(15, 0),
  ...
  split_from_line_id DECIMAL(15, 0),
  cust_production_seq_num STRING,
  authorized_to_ship_flag STRING,
  over_ship_reason_code STRING,
  over_ship_resolved_flag STRING,
  ordered_item_id DECIMAL(15, 0),
  item_identifier_type STRING,
  configuration_id DECIMAL(15, 0),
  commitment_id DECIMAL(15, 0),
  shipping_interfaced_flag STRING,
  credit_invoice_line_id DECIMAL(15, 0),
  first_ack_code STRING,
  first_ack_date TIMESTAMP,
  last_ack_code STRING,
  last_ack_date TIMESTAMP,
  planning_priority DECIMAL(15, 0),
  ...
  customer_shipment_number STRING,
  customer_item_net_price DECIMAL(28, 10),
  customer_payment_term_id DECIMAL(15, 0),
  fulfilled_flag STRING,
  end_item_unit_number STRING,
  config_header_id DECIMAL(15, 0),
  config_rev_nbr DECIMAL(15, 0),
  mfg_component_sequence_id DECIMAL(15, 0),
  shipping_instructions STRING,
  packing_instructions STRING,
  invoiced_quantity DECIMAL(28, 10),
  reference_customer_trx_line_id DECIMAL(15, 0),
  split_by STRING,
  line_set_id DECIMAL(15, 0),
  service_txn_reason_code STRING,
  service_txn_comments STRING,
  service_duration DECIMAL(15, 0),
  service_start_date TIMESTAMP,
  service_end_date TIMESTAMP,
  service_coterminate_flag STRING,
  unit_list_percent DECIMAL(28, 10),
  unit_selling_percent DECIMAL(28, 10),
  unit_percent_base_price DECIMAL(28, 10),
  service_number DECIMAL(15, 0),
  service_period STRING,
  shippable_flag STRING,
  model_remnant_flag STRING,
  re_source_flag STRING,
  ...
  service_reference_type_code STRING,
  service_reference_line_id DECIMAL(15, 0),
  service_reference_system_id DECIMAL(15, 0),
  ...
  ordered_quantity2 DECIMAL(28, 10),
  ordered_quantity_uom2 STRING,
  shipping_quantity2 DECIMAL(28, 10),
  cancelled_quantity2 DECIMAL(28, 10),
  shipped_quantity2 DECIMAL(28, 10),
  shipping_quantity_uom2 STRING,
  fulfilled_quantity2 DECIMAL(28, 10),
  mfg_lead_time DECIMAL(15, 0),
  lock_control DECIMAL(15, 0),
  subinventory STRING,
  unit_list_price_per_pqty DECIMAL(28, 10),
  unit_selling_price_per_pqty DECIMAL(28, 10),
  price_request_code STRING,
  original_inventory_item_id DECIMAL(15, 0),
  original_ordered_item_id DECIMAL(15, 0),
  original_ordered_item STRING,
  original_item_identifier_type STRING,
  item_substitution_type_code STRING,
  override_atp_date_code STRING,
  late_demand_penalty_factor DECIMAL(28, 10),
  ...
  attribute19 STRING,
  attribute20 STRING,
  user_item_description STRING,
  unit_cost DECIMAL(28, 10),
  item_relationship_type DECIMAL(15, 0),
  blanket_line_number DECIMAL(15, 0),
  blanket_number DECIMAL(15, 0),
  blanket_version_number DECIMAL(15, 0),
  sales_document_type_code STRING,
  firm_demand_flag STRING,
  ...
  retrobill_request_id DECIMAL(15, 0),
  original_list_price DECIMAL(28, 10),
  service_credit_eligible_code STRING,
  order_firmed_date TIMESTAMP,
  actual_fulfillment_date TIMESTAMP,
  charge_periodicity_code STRING,
  contingency_id DECIMAL(15, 0),
  revrec_event_code STRING,
  revrec_expiration_days DECIMAL(15, 0),
  accepted_quantity DECIMAL(28, 10),
  accepted_by DECIMAL(15, 0),
  revrec_comments STRING,
  revrec_reference_document STRING,
  revrec_signature STRING,
  revrec_signature_date TIMESTAMP,
  revrec_implicit_flag STRING,
  billing_plan_header_id DECIMAL(15, 0),
  bypass_sch_flag STRING,
  container_number STRING,
  equipment_id DECIMAL(15, 0),
  fulfillment_base STRING,
  inst_id DECIMAL(15, 0),
  pre_exploded_flag STRING,
  require_billing_validation STRING,
  service_bill_option_code STRING,
  service_bill_profile_id DECIMAL(15, 0),
  service_cov_template_id DECIMAL(15, 0),
  service_first_period_amount DECIMAL(28, 10),
  service_first_period_enddate TIMESTAMP,
  service_subs_template_id DECIMAL(15, 0),
  source_order_line_id DECIMAL(15, 0),
  subscription_enable_flag STRING,
  tax_line_value DECIMAL(28, 10),
  vrm_last_update_date TIMESTAMP,
  KCA_OPERATION STRING,
  IS_DELETED_FLG STRING,
  kca_seq_id DECIMAL(36, 0),
  kca_seq_date TIMESTAMP
);
INSERT INTO silver_bec_ods.OE_ORDER_LINES_ALL (
  line_id,
  org_id,
  header_id,
  line_type_id,
...
SELECT
  ...
  kca_seq_date
FROM bronze_bec_ods_stg.OE_ORDER_LINES_ALL;
