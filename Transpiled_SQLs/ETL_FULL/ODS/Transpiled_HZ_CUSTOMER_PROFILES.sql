DROP TABLE IF EXISTS silver_bec_ods.hz_customer_profiles;
CREATE TABLE IF NOT EXISTS silver_bec_ods.hz_customer_profiles (
  ...
  next_credit_review_date TIMESTAMP,
  ...
  percent_collectable DECIMAL(15, 0),
  ...
  review_cycle STRING,
  last_credit_review_date TIMESTAMP,
