DROP TABLE IF EXISTS silver_bec_ods.ap_suppliers;
CREATE TABLE IF NOT EXISTS silver_bec_ods.ap_suppliers (
  ...
  credit_status_lookup_code STRING,
  credit_limit DECIMAL(28, 10),
  ...
  exchange_date_lookup_code STRING,
  ...
  expense_code_combination_id DECIMAL(15, 0),
  ...
  ni_number STRING,
  tca_sync_num_1099 STRING,
  tca_sync_vendor_name STRING,
  tca_sync_vat_reg_num STRING,
  individual_1099 STRING,
  unique_tax_reference_num DECIMAL(15, 0),
  partnership_utr DECIMAL(15, 0),
  partnership_name STRING,
  cis_enabled_flag STRING,
  first_name STRING,
  second_name STRING,
  last_name STRING,
  salutation STRING,
  ...
  verification_request_id DECIMAL(15, 0),
  match_status_flag STRING,
  cis_verification_date TIMESTAMP,
  pay_awt_group_id DECIMAL(15, 0),
  cis_parent_vendor_id DECIMAL(15, 0),
  bus_class_last_certified_date TIMESTAMP,
  bus_class_last_certified_by DECIMAL(15, 0),
...
INSERT INTO silver_bec_ods.ap_suppliers (
  vendor_id,
  last_update_date,
  last_updated_by,
  vendor_name,
...
(
  SELECT
    ...
    kca_seq_date
  FROM bronze_bec_ods_stg.ap_suppliers
);
