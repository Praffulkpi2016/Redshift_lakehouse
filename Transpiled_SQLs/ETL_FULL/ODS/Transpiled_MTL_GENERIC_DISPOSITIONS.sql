DROP TABLE IF EXISTS silver_bec_ods.MTL_GENERIC_DISPOSITIONS;
CREATE TABLE IF NOT EXISTS silver_bec_ods.MTL_GENERIC_DISPOSITIONS (
  ...
  distribution_account DECIMAL(15, 0),
  segment1 STRING,
  segment2 STRING,
  segment3 STRING,
  segment4 STRING,
