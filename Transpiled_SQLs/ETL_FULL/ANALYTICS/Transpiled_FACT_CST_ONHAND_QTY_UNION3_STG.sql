DROP table IF EXISTS gold_bec_dwh.FACT_CST_ONHAND_QTY_UNION3_STG;
CREATE TABLE gold_bec_dwh.FACT_CST_ONHAND_QTY_UNION3_STG AS
(
  SELECT
    mmt.segment1,
    mmt.cat_seg1,
...
WHERE
  dw_table_name = 'fact_cst_onhand_qty_union3_stg' AND batch_name = 'costing';