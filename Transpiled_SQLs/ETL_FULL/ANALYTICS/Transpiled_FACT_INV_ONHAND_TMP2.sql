DROP table IF EXISTS gold_bec_dwh.FACT_INV_ONHAND_TMP2;
CREATE TABLE gold_bec_dwh.FACT_INV_ONHAND_TMP2 AS
SELECT DISTINCT
...
DROP table IF EXISTS gold_bec_dwh.qty CASCADE;
CREATE TABLE gold_bec_dwh.qty AS
(
  SELECT
