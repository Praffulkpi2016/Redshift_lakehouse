DROP table IF EXISTS gold_bec_dwh_rpt.FACT_MAT_DIST_SO_SLNO_RT;
CREATE TABLE gold_bec_dwh_rpt.FACT_MAT_DIST_SO_SLNO_RT AS
(
  WITH CTE_INSTALL AS (
    SELECT
      install.party_name,
  ...
  FROM gold_bec_dwh.fact_cst_inv_distribution_stg2 AS mtrx, gold_bec_dwh.dim_gl_accounts AS gcc, gold_bec_dwh.dim_inv_master_items AS msi, (
    SELECT
      *
