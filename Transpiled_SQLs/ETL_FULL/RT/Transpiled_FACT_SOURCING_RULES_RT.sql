DROP table IF EXISTS gold_bec_dwh.FACT_SOURCING_RULES_RT_STG1;
CREATE TABLE gold_bec_dwh.FACT_SOURCING_RULES_RT_STG1 AS
(
...
DROP table IF EXISTS gold_bec_dwh.FACT_SOURCING_RULES_RT_STG2;
CREATE TABLE gold_bec_dwh.FACT_SOURCING_RULES_RT_STG2 AS
(
  WITH MRP_ASSIGNMENTS AS (
    SELECT
      organization_id,
...
DROP table IF EXISTS gold_bec_dwh_rpt.FACT_SOURCING_RULES_RT;
CREATE TABLE gold_bec_dwh_rpt.FACT_SOURCING_RULES_RT AS
(
  SELECT
    *
