TRUNCATE table gold_bec_dwh.FACT_BOM_COST_DETAILS;
INSERT INTO gold_bec_dwh.FACT_BOM_COST_DETAILS
SELECT
  top_item_id,
  assembly_item_id,
  component_item_id,
...
FROM (
  ...
  FROM silver_bec_ods.xxbec_ibom_rc_temp AS xib, silver_bec_ods.mtl_system_items_b AS msi, silver_bec_ods.mtl_system_items_b AS msi2, silver_bec_ods.bom_structures_b AS bom, silver_bec_ods.mtl_system_items_b AS msi3, silver_bec_ods.fnd_lookup_values AS lu1, silver_bec_ods.fnd_lookup_values AS lu2
  WHERE
    1 = 1
