TRUNCATE table gold_bec_dwh.cte_xla_ae_headers;
INSERT INTO gold_bec_dwh.CTE_xla_ae_headers
(
  SELECT
  ...
  FROM (
    ...
    WHERE
      ...
      AND (
        last_update_date >= TO_DATE('2020-01-01 12:00:00', 'YYYY-MM-DD HH:MI:SS')
        AND kca_seq_date >= (
          SELECT
            (
...
TRUNCATE table  gold_bec_dwh.cte_xla_ae_lines;
INSERT INTO gold_bec_dwh.cte_xla_ae_lines
(
  SELECT
...
TRUNCATE table gold_bec_dwh.cte_xla_event_types_tl;
INSERT INTO gold_bec_dwh.cte_xla_event_types_tl
(
  SELECT
...
TRUNCATE table gold_bec_dwh.CTE_xla_Event_classes_tl;
INSERT INTO gold_bec_dwh.CTE_xla_Event_classes_tl
(
  SELECT
...
TRUNCATE table gold_bec_dwh.cte_xla_events;
INSERT INTO gold_bec_dwh.cte_xla_events
(
  SELECT
...
TRUNCATE table gold_bec_dwh.CTE_xla_transaction_entities;
INSERT INTO gold_bec_dwh.CTE_xla_transaction_entities
(
  SELECT
...
TRUNCATE table gold_bec_dwh.CTE_xla_distribution_links;
INSERT INTO gold_bec_dwh.CTE_xla_distribution_links
(
  SELECT
...
TRUNCATE table gold_bec_dwh.CTE_fnd_lookup_values;
INSERT INTO gold_bec_dwh.CTE_fnd_lookup_values
(
  SELECT
    xlk2.lookup_type,
    xlk2.lookup_code,
...
TRUNCATE table gold_bec_dwh.CTE_fun_seq_versions1;
INSERT INTO gold_bec_dwh.CTE_fun_seq_versions1
(
  SELECT
...
TRUNCATE table gold_bec_dwh.CTE_OM;
INSERT INTO gold_bec_dwh.CTE_OM
(
  SELECT
...
TRUNCATE table gold_bec_dwh.CTE_REC;
INSERT INTO gold_bec_dwh.CTE_REC
(
  SELECT
    hl.address1,
...
TRUNCATE table gold_bec_dwh.CTE_ADJ;
INSERT INTO gold_bec_dwh.CTE_ADJ
(
  SELECT
    hl.address1,
    adj.adjustment_id
...
TRUNCATE table gold_bec_dwh.FACT_GL_XLA_STG;
...
INSERT INTO gold_bec_dwh.FACT_GL_XLA_STG
(
  SELECT DISTINCT
    aeh.GL_DATE,
    aeh.CREATION_DATE,
