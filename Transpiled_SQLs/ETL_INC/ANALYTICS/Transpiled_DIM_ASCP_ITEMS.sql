TRUNCATE table gold_bec_dwh.DIM_ASCP_ITEMS;
INSERT INTO gold_bec_dwh.DIM_ASCP_ITEMS
(
  SELECT
    plan_id,
    sr_instance_id,
  ...
  FROM (
    SELECT
      ...
      (
        ...
        WHERE
          is_deleted_flg <> 'Y'
          AND lookup_type = 'MRP_PLANNING_CODE'
      ...
      (
        ...
        WHERE
          is_deleted_flg <> 'Y'
          AND lookup_type = 'MRP_HARD_PEGGING_LEVEL'
      ...
      (
        ...
        WHERE
          is_deleted_flg <> 'Y'
          AND lookup_type = 'MSC_ATP_COMPONENTS_FLAG'
    ...
    FROM (
      ...
      SELECT
        *
      FROM silver_bec_ods.msc_item_categories
      WHERE
        is_deleted_flg <> 'Y'
    ) AS mic
    WHERE
