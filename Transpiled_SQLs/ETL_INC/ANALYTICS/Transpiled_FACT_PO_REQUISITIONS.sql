TRUNCATE table gold_bec_dwh.FACT_PO_REQUISITIONS_TMP;
INSERT INTO gold_bec_dwh.FACT_PO_REQUISITIONS_TMP
(
  SELECT DISTINCT
    PD.PO_LINE_ID,
    PD.PO_HEADER_ID,
...
TRUNCATE table gold_bec_dwh.FACT_PO_REQUISITIONS_TMP_SBQ;
INSERT INTO gold_bec_dwh.FACT_PO_REQUISITIONS_TMP_SBQ
(
  SELECT
    EMPLOYEE_ID,
    OBJECT_ID,
...
TRUNCATE table gold_bec_dwh.FACT_PO_REQUISITIONS_TMP_aprvr;
INSERT INTO gold_bec_dwh.FACT_PO_REQUISITIONS_TMP_aprvr
(
  SELECT
    employee_id,
    object_id
...
TRUNCATE table gold_bec_dwh.FACT_PO_REQUISITIONS_TMP_aprvr_new;
INSERT INTO gold_bec_dwh.FACT_PO_REQUISITIONS_TMP_aprvr_new
(
  SELECT
    employee_id,
    object_id,
...
TRUNCATE table gold_bec_dwh.FACT_PO_REQUISITIONS;
INSERT INTO gold_bec_dwh.FACT_PO_REQUISITIONS
(
  SELECT DISTINCT
    RQ.ORG_ID,
    (
  ...
  FROM (
    ...
    WHERE
      is_deleted_flg <> 'Y'
  ) AS RD, gold_bec_dwh.FACT_PO_REQUISITIONS_TMP AS PRL, gold_bec_dwh.FACT_PO_REQUISITIONS_TMP_SBQ AS SBQ, gold_bec_dwh.FACT_PO_REQUISITIONS_TMP_aprvr AS aprvr, gold_bec_dwh.FACT_PO_REQUISITIONS_TMP_aprvr_new AS aprvr_new, (
    SELECT
      release_date,
      po_release_id,
      po_header_id
