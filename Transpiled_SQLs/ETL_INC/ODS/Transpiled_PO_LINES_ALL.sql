/* Delete Records */
DELETE FROM silver_bec_ods.po_lines_all
WHERE
  PO_LINE_ID IN (
    SELECT
      stg.PO_LINE_ID
    FROM silver_bec_ods.po_lines_all AS ods, bronze_bec_ods_stg.po_lines_all AS stg
    WHERE
      ods.PO_LINE_ID = stg.PO_LINE_ID AND stg.kca_operation IN ('INSERT', 'UPDATE')
  );
/* Insert records */
...
/* Soft delete */
UPDATE silver_bec_ods.po_lines_all SET IS_DELETED_FLG = 'N';
UPDATE silver_bec_ods.po_lines_all SET IS_DELETED_FLG = 'Y'
WHERE
  (
    PO_LINE_ID
  ) IN (
