/* Delete Records */
DELETE FROM silver_bec_ods.WSH_DELIVERY_DETAILS
WHERE
  COALESCE(DELIVERY_DETAIL_ID, 0) IN (
    SELECT
      COALESCE(stg.DELIVERY_DETAIL_ID, 0)
    FROM silver_bec_ods.WSH_DELIVERY_DETAILS AS ods, bronze_bec_ods_stg.WSH_DELIVERY_DETAILS AS stg
    WHERE
      ods.DELIVERY_DETAIL_ID = stg.DELIVERY_DETAIL_ID
...
/* Soft delete */
UPDATE silver_bec_ods.WSH_DELIVERY_DETAILS SET IS_DELETED_FLG = 'N';
UPDATE silver_bec_ods.WSH_DELIVERY_DETAILS SET IS_DELETED_FLG = 'Y'
WHERE
  (
    DELIVERY_DETAIL_ID
  ) IN (
    ...
    WHERE
      (DELIVERY_DETAIL_ID, KCA_SEQ_ID) IN (
        SELECT
          DELIVERY_DETAIL_ID,
