/* Delete Records */
DELETE FROM silver_bec_ods.AR_PAYMENT_SCHEDULES_ALL
WHERE
  payment_schedule_id IN (
    SELECT
      stg.payment_schedule_id
    FROM silver_bec_ods.AR_PAYMENT_SCHEDULES_ALL AS ods, bronze_bec_ods_stg.AR_PAYMENT_SCHEDULES_ALL AS stg
    WHERE
      ods.payment_schedule_id = stg.payment_schedule_id
...
/* Soft delete */
UPDATE silver_bec_ods.AR_PAYMENT_SCHEDULES_ALL SET IS_DELETED_FLG = 'N';
UPDATE silver_bec_ods.AR_PAYMENT_SCHEDULES_ALL SET IS_DELETED_FLG = 'Y'
WHERE
  (
    payment_schedule_id
  ) IN (
    ...
    WHERE
      (payment_schedule_id, KCA_SEQ_ID) IN (
        SELECT
          payment_schedule_id,
