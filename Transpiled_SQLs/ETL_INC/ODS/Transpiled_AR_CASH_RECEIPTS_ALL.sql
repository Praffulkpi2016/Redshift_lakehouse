/* Delete Records */
DELETE FROM silver_bec_ods.AR_CASH_RECEIPTS_ALL
WHERE
  cash_receipt_id IN (
    SELECT
      stg.cash_receipt_id
    FROM silver_bec_ods.AR_CASH_RECEIPTS_ALL AS ods, bronze_bec_ods_stg.AR_CASH_RECEIPTS_ALL AS stg
    WHERE
      ods.cash_receipt_id = stg.cash_receipt_id
...
/* Soft delete */
UPDATE silver_bec_ods.AR_CASH_RECEIPTS_ALL SET IS_DELETED_FLG = 'N';
UPDATE silver_bec_ods.AR_CASH_RECEIPTS_ALL SET IS_DELETED_FLG = 'Y'
WHERE
  (
    cash_receipt_id
  ) IN (
