/* Delete Records */
DELETE FROM silver_bec_ods.po_headers_all
WHERE
  PO_HEADER_ID IN (
    SELECT
      stg.PO_HEADER_ID
    FROM silver_bec_ods.po_headers_all AS ods, bronze_bec_ods_stg.po_headers_all AS stg
    WHERE
      ods.PO_HEADER_ID = stg.PO_HEADER_ID AND stg.kca_operation IN ('INSERT', 'UPDATE')
  );
/* Insert records */
...
/* Soft delete */
UPDATE silver_bec_ods.po_headers_all SET IS_DELETED_FLG = 'N';
UPDATE silver_bec_ods.po_headers_all SET IS_DELETED_FLG = 'Y'
WHERE
  (
    PO_HEADER_ID
  ) IN (
