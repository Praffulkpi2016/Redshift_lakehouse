/* Delete Records */
DELETE FROM silver_bec_ods.PO_REQUISITION_LINES_ALL
WHERE
  REQUISITION_LINE_ID IN (
    SELECT
      stg.REQUISITION_LINE_ID
    FROM silver_bec_ods.PO_REQUISITION_LINES_ALL AS ods, bronze_bec_ods_stg.PO_REQUISITION_LINES_ALL AS stg
    WHERE
      ods.REQUISITION_LINE_ID = stg.REQUISITION_LINE_ID
...
/* Soft delete */
UPDATE silver_bec_ods.PO_REQUISITION_LINES_ALL SET IS_DELETED_FLG = 'N';
UPDATE silver_bec_ods.PO_REQUISITION_LINES_ALL SET IS_DELETED_FLG = 'Y'
WHERE
  (
    REQUISITION_LINE_ID
  ) IN (
    ...
    WHERE
      (REQUISITION_LINE_ID, KCA_SEQ_ID) IN (
        SELECT
          REQUISITION_LINE_ID,
