/* Delete Records */
DELETE FROM silver_bec_ods.HZ_LOCATIONS
WHERE
  LOCATION_ID IN (
    SELECT
      stg.LOCATION_ID
    FROM silver_bec_ods.HZ_LOCATIONS AS ods, bronze_bec_ods_stg.HZ_LOCATIONS AS stg
    WHERE
...
/* Soft delete */
UPDATE silver_bec_ods.HZ_LOCATIONS SET IS_DELETED_FLG = 'N';
UPDATE silver_bec_ods.HZ_LOCATIONS SET IS_DELETED_FLG = 'Y'
WHERE
  (
    LOCATION_ID
  ) IN (
