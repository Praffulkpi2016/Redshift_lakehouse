/* Delete Records */
DELETE FROM silver_bec_ods.AR_RECEIVABLE_APPLICATIONS_ALL
WHERE
  receivable_application_id IN (
    SELECT
      stg.receivable_application_id
    FROM silver_bec_ods.AR_RECEIVABLE_APPLICATIONS_ALL AS ods, bronze_bec_ods_stg.AR_RECEIVABLE_APPLICATIONS_ALL AS stg
    WHERE
      ods.receivable_application_id = stg.receivable_application_id
...
/* Soft delete */
UPDATE silver_bec_ods.AR_RECEIVABLE_APPLICATIONS_ALL SET IS_DELETED_FLG = 'N';
UPDATE silver_bec_ods.AR_RECEIVABLE_APPLICATIONS_ALL SET IS_DELETED_FLG = 'Y'
WHERE
  (
    receivable_application_id
  ) IN (
    ...
    WHERE
      (receivable_application_id, KCA_SEQ_ID) IN (
        SELECT
          receivable_application_id,
