/* Delete Records */
DELETE FROM silver_bec_ods.OE_ORDER_LINES_ALL
WHERE
  (
    COALESCE(LINE_ID, 0)
  ) IN (
    ...
    FROM silver_bec_ods.OE_ORDER_LINES_ALL AS ods, bronze_bec_ods_stg.OE_ORDER_LINES_ALL AS stg
    WHERE
...
/* Soft delete */
UPDATE silver_bec_ods.OE_ORDER_LINES_ALL SET IS_DELETED_FLG = 'N';
UPDATE silver_bec_ods.OE_ORDER_LINES_ALL SET IS_DELETED_FLG = 'Y'
WHERE
  (
    LINE_ID
  ) IN (
