/* Delete Records */
DELETE FROM silver_bec_ods.RA_CUSTOMER_TRX_LINES_ALL
WHERE
  CUSTOMER_TRX_LINE_ID IN (
    SELECT
      stg.CUSTOMER_TRX_LINE_ID
    FROM silver_bec_ods.RA_CUSTOMER_TRX_LINES_ALL AS ods, bronze_bec_ods_stg.RA_CUSTOMER_TRX_LINES_ALL AS stg
    WHERE
      ods.CUSTOMER_TRX_LINE_ID = stg.CUSTOMER_TRX_LINE_ID
...
/* Soft delete */
UPDATE silver_bec_ods.RA_CUSTOMER_TRX_LINES_ALL SET IS_DELETED_FLG = 'N';
UPDATE silver_bec_ods.RA_CUSTOMER_TRX_LINES_ALL SET IS_DELETED_FLG = 'Y'
WHERE
  (
    CUSTOMER_TRX_LINE_ID
  ) IN (
    ...
    WHERE
      (CUSTOMER_TRX_LINE_ID, KCA_SEQ_ID) IN (
        SELECT
          CUSTOMER_TRX_LINE_ID,
