/* Delete Records */
DELETE FROM silver_bec_ods.ap_suppliers
WHERE
  vendor_id IN (
    SELECT
      stg.vendor_id
    FROM silver_bec_ods.ap_suppliers AS ods, bronze_bec_ods_stg.ap_suppliers AS stg
    WHERE
      ods.vendor_id = stg.vendor_id AND stg.kca_operation IN ('INSERT', 'UPDATE')
  );
/* Insert records */
...
/* Soft delete */
UPDATE silver_bec_ods.ap_suppliers SET IS_DELETED_FLG = 'N';
UPDATE silver_bec_ods.ap_suppliers SET IS_DELETED_FLG = 'Y'
WHERE
  (
    vendor_id
  ) IN (
