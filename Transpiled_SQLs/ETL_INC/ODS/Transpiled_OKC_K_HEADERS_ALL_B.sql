/* Delete Records */
DELETE FROM silver_bec_ods.OKC_K_HEADERS_ALL_B
WHERE
  ID IN (
    SELECT
      stg.ID
    FROM silver_bec_ods.OKC_K_HEADERS_ALL_B AS ods, bronze_bec_ods_stg.OKC_K_HEADERS_ALL_B AS stg
    WHERE
...
/* Soft delete */
UPDATE silver_bec_ods.OKC_K_HEADERS_ALL_B SET IS_DELETED_FLG = 'N';
UPDATE silver_bec_ods.OKC_K_HEADERS_ALL_B SET IS_DELETED_FLG = 'Y'
WHERE
  (
    COALESCE(ID, 0)
  ) IN (
