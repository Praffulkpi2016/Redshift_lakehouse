/* Delete Records */
DELETE FROM silver_bec_ods.mtl_parameters
WHERE
  ORGANIZATION_ID IN (
    SELECT
      stg.ORGANIZATION_ID
    FROM silver_bec_ods.mtl_parameters AS ods, bronze_bec_ods_stg.mtl_parameters AS stg
    WHERE
...
/* Soft delete */
UPDATE silver_bec_ods.mtl_parameters SET IS_DELETED_FLG = 'N';
UPDATE silver_bec_ods.mtl_parameters SET IS_DELETED_FLG = 'Y'
WHERE
  (
    ORGANIZATION_ID
  ) IN (
