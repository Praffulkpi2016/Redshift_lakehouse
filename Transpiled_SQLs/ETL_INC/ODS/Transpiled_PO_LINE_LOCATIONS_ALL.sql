/* Delete Records */
DELETE FROM silver_bec_ods.po_line_locations_all
WHERE
  LINE_LOCATION_ID IN (
    SELECT
      stg.LINE_LOCATION_ID
    FROM silver_bec_ods.po_line_locations_all AS ods, bronze_bec_ods_stg.po_line_locations_all AS stg
    WHERE
      ods.LINE_LOCATION_ID = stg.LINE_LOCATION_ID
...
/* Soft delete */
UPDATE silver_bec_ods.po_line_locations_all SET IS_DELETED_FLG = 'N';
UPDATE silver_bec_ods.po_line_locations_all SET IS_DELETED_FLG = 'Y'
WHERE
  (
    LINE_LOCATION_ID
  ) IN (
    ...
    WHERE
      (LINE_LOCATION_ID, KCA_SEQ_ID) IN (
        SELECT
          LINE_LOCATION_ID,
