/* Delete Records */
DELETE FROM silver_bec_ods.ap_invoice_distributions_all
WHERE
  invoice_distribution_id IN (
    SELECT
      stg.invoice_distribution_id
    FROM silver_bec_ods.ap_invoice_distributions_all AS ods, bronze_bec_ods_stg.ap_invoice_distributions_all AS stg
    WHERE
      ods.invoice_distribution_id = stg.invoice_distribution_id
...
/* Soft delete */
UPDATE silver_bec_ods.ap_invoice_distributions_all SET IS_DELETED_FLG = 'N';
UPDATE silver_bec_ods.ap_invoice_distributions_all SET IS_DELETED_FLG = 'Y'
WHERE
  (
    invoice_distribution_id
  ) IN (
    ...
    WHERE
      (invoice_distribution_id, KCA_SEQ_ID) IN (
        SELECT
          invoice_distribution_id,
