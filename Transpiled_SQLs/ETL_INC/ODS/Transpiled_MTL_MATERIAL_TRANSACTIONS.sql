/* Delete Records */
DELETE FROM silver_bec_ods.MTL_MATERIAL_TRANSACTIONS
WHERE
  TRANSACTION_ID IN (
    SELECT
      stg.TRANSACTION_ID
    FROM silver_bec_ods.MTL_MATERIAL_TRANSACTIONS AS ods, bronze_bec_ods_stg.MTL_MATERIAL_TRANSACTIONS AS stg
    WHERE
...
/* Soft delete */
UPDATE silver_bec_ods.MTL_MATERIAL_TRANSACTIONS SET IS_DELETED_FLG = 'N';
UPDATE silver_bec_ods.MTL_MATERIAL_TRANSACTIONS SET IS_DELETED_FLG = 'Y'
WHERE
  (
    TRANSACTION_ID
  ) IN (
