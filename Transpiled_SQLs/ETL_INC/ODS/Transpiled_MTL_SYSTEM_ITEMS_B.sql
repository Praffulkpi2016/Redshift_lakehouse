/* Delete Records */
DELETE FROM silver_bec_ods.mtl_system_items_b
WHERE
  (INVENTORY_ITEM_ID, ORGANIZATION_ID) IN (
    SELECT
      stg.INVENTORY_ITEM_ID,
      stg.ORGANIZATION_ID
    FROM silver_bec_ods.mtl_system_items_b AS ods, bronze_bec_ods_stg.mtl_system_items_b AS stg
    WHERE
...
(
  ...
  WHERE
    ...
    AND (INVENTORY_ITEM_ID, ORGANIZATION_ID, kca_seq_id) IN (
      SELECT
        INVENTORY_ITEM_ID,
        ORGANIZATION_ID,
        MAX(kca_seq_id)
...
/* Soft delete */
UPDATE silver_bec_ods.mtl_system_items_b SET IS_DELETED_FLG = 'N';
UPDATE silver_bec_ods.mtl_system_items_b SET IS_DELETED_FLG = 'Y'
WHERE
  (INVENTORY_ITEM_ID, ORGANIZATION_ID) IN (
    SELECT
      INVENTORY_ITEM_ID,
    ...
    WHERE
      (INVENTORY_ITEM_ID, ORGANIZATION_ID, KCA_SEQ_ID) IN (
        SELECT
          INVENTORY_ITEM_ID,
          ORGANIZATION_ID,
