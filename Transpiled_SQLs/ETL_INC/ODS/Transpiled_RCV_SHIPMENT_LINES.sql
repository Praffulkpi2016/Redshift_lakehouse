/* Delete Records */
DELETE FROM silver_bec_ods.rcv_shipment_lines
WHERE
  SHIPMENT_LINE_ID IN (
    SELECT
      stg.SHIPMENT_LINE_ID
    FROM silver_bec_ods.rcv_shipment_lines AS ods, bronze_bec_ods_stg.rcv_shipment_lines AS stg
    WHERE
...
(
  ...
  WHERE
    ...
    AND (SHIPMENT_LINE_ID, kca_seq_id) IN (
      SELECT
        SHIPMENT_LINE_ID,
        MAX(kca_seq_id)
      FROM bronze_bec_ods_stg.rcv_shipment_lines
...
/* Soft delete */
UPDATE silver_bec_ods.rcv_shipment_lines SET IS_DELETED_FLG = 'N';
UPDATE silver_bec_ods.rcv_shipment_lines SET IS_DELETED_FLG = 'Y'
WHERE
  (
    SHIPMENT_LINE_ID
  ) IN (
    ...
    WHERE
      (SHIPMENT_LINE_ID, KCA_SEQ_ID) IN (
        SELECT
          SHIPMENT_LINE_ID,
