/* Delete Records */
DELETE FROM silver_bec_ods.ap_expense_report_headers_all
WHERE
  REPORT_HEADER_ID IN (
    SELECT
      stg.REPORT_HEADER_ID
    FROM silver_bec_ods.ap_expense_report_headers_all AS ods, bronze_bec_ods_stg.ap_expense_report_headers_all AS stg
    WHERE
      ods.REPORT_HEADER_ID = stg.REPORT_HEADER_ID
...
/* Soft delete */
UPDATE silver_bec_ods.ap_expense_report_headers_all SET IS_DELETED_FLG = 'N';
UPDATE silver_bec_ods.ap_expense_report_headers_all SET IS_DELETED_FLG = 'Y'
WHERE
  (
    REPORT_HEADER_ID
  ) IN (
    ...
    WHERE
      (REPORT_HEADER_ID, KCA_SEQ_ID) IN (
        SELECT
          REPORT_HEADER_ID,
