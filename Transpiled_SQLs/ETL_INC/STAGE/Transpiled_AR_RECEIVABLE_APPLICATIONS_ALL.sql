TRUNCATE table bronze_bec_ods_stg.AR_RECEIVABLE_APPLICATIONS_ALL;
INSERT INTO bronze_bec_ods_stg.AR_RECEIVABLE_APPLICATIONS_ALL (
...
(
  SELECT
    ...
    acctd_unearned_discount_taken,
    reversal_gl_date,
    cash_receipt_history_id, /*	reversal_gl_date_context, */
    org_id,
    tax_code,
    global_attribute1,
    global_attribute2,
